...
ActiveRecord::Schema.define(version: 2021_12_03_085744) do
  ...
  create_table "aims", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "goal"
    ...
    t.index ["user_id"], name: "index_aims_on_user_id"
  end
